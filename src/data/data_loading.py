...
from src.data.transforms import Compose, NoDataReplace, RandomFlip, Normalize, RemoveChannel
...
def get_dataloaders(cfg):
    ...
    for dataset_type in ["train", "val", "test"]:
        transforms_pipeline = Compose([
            NoDataReplace(global_means=mean, nodata_value=cfg.dataset.nodata_value),
