...
from benchmarking.models.UTAE.ltae import LTAE2d
...
class UTAE(nn.Module):
    def __init__(
        ...
        out_conv = [config["batch_size"], config["num_classes"]]
        ...
        self.in_conv = ConvBlock(
            nkernels=[self.input_dim] + [encoder_widths[0], encoder_widths[0]],
            pad_value=pad_value,
            norm=encoder_norm,
