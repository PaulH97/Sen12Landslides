...
from benchmarking.models.UNet2D_CLSTM.LocalSelfAttention.cscl import ContextSelfSimilarity, AttentionAggregate
...
class UNet3D_CSCL(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.backbone_arch = get_params_values(config, 'backbone', 'UNET3D') # set to UNET3D
